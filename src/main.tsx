  ...
  return <div>
    ...
    <div class={[flex, col, "cfg"]}>
      ...
      <div class={[flex, "buttons"]}>
        ...
        <button on:click={() => SetTransport("CurlMod.LibcurlClient", { wisp: store.wispurl, wasm: "https://cdn.jsdelivr.net/npm/libcurl.js@latest/libcurl.wasm"})}>use libcurl.js</button>
